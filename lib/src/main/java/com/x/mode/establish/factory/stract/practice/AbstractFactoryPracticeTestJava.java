 ...
 */
public class AbstractFactoryPracticeTestJava {

    public static void main(String[] args) {
        ControllerFactory factory = new WindowsControllerFactory();
        factory.createOperationController().controller();
        factory.createWidgetController().controller();
    }
}
